...
// refer: https://www.youtube.com/watch?v=KGmV8-NdPgE
// store implementation and admin in another slot rather then 0 and 1 slot, so we don't need:
//      address public implementation
//      address public admin
//
contract Proxy {
...
library StorageSlot {
  //wrap addr in strurct
  struct AddressSlot {
    address value;
  }

  // get the pointer to any slot you want
  // Uses inline assembly to directly interact with storage
  // r: pointer to the addressSlot
...
contract TestSlot {
  // storing address located at slot
